...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/codegen-sep16-1](https://github.com/rhdh-JslYoon-org/codegen-sep16-1)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/codegen-sep16-1-gitops](https://github.com/rhdh-JslYoon-org/codegen-sep16-1-gitops)

# **Usage**

To access the codegen-sep16-1 application that was deployed using the Software Template, complete the following instructions:
